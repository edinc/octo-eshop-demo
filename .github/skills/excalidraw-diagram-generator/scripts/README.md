...
1. **Create library directory**:
   ...
   ```bash
   mkdir -p skills/excalidraw-diagram-generator/libraries/azure-architecture-icons
   ```

2. **Download and place library file**:
   - Visit: https://libraries.excalidraw.com/
   - Search for "azure Architecture Icons" and download the `.excalidrawlib` file
   - Rename it to match the directory name: `azure-architecture-icons.excalidrawlib`
   - Place it in the directory created in step 1

3. **Run the script**:
   ```bash
   python skills/excalidraw-diagram-generator/scripts/split-excalidraw-library.py skills/excalidraw-diagram-generator/libraries/azure-architecture-icons/
   ```
...
```
skills/excalidraw-diagram-generator/libraries/azure-architecture-icons/
  azure-architecture-icons.excalidrawlib  # Original file (kept)
...
- **azure Architecture Icons**: Subject to azure Content License
...
- `--library-path PATH` : Path to the icon library directory (default: `azure-architecture-icons`)
