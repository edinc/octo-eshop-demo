...
<Aside type="tip">
  Practice the full sequence once before presenting. Copilot responses vary
  slightly each time — familiarity helps you narrate confidently.
</Aside>
...
<Steps>
  ...
  4. **Security Overview:** Navigate to Security → Overview. Show the unified dashboard.
</Steps>
...
<Aside type="caution" title="If something goes wrong">
  ...
  - **Agent times out:** Retry the prompt or use a simpler version.
  - **Code doesn't compile:** Narrate it as a learning moment — _"This is why we review AI output."_
  - **Unexpected CodeQL results:** Focus on the Autofix capability rather than specific findings.
</Aside>
